...
class Configuracao_google_maps_Activity : AppCompatActivity(), OnMapReadyCallback{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_configuracao_google_maps)
        ...
        try {
            ...
            mMap.setInfoWindowAdapter(object : InfoWindowAdapter {
                override fun getInfoContents(marker: Marker): View {
                    val tv = TextView(this@Configuracao_google_maps_Activity)//vermelho
                    tv.text = Html.fromHtml("<b><font color=\"#ffffff\">" + marker.title + ":</font></b> " + marker.snippet)
                    return tv
                }
                override fun getInfoWindow(marker: Marker): View {

                    val ll = LinearLayout(this@Configuracao_google_maps_Activity)
                    ll.setPadding(10, 10, 10, 10)
                    ll.setBackgroundColor(Color.WHITE)
                    val tv = TextView(this@Configuracao_google_maps_Activity)//preto
            ...
            if(semnet != "sim" && mostrar != "atualiza") {//esta sem net
                mMap.setOnInfoWindowClickListener { marker ->
                    ...
                    val handle = Handler()
                    var url:String = ""
                    val intent = Intent(applicationContext, Tela_vizualiza_publicacoes_recentes_Activity::class.java)
