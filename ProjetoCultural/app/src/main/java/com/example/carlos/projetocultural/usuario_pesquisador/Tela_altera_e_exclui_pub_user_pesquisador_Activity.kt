...
class Tela_altera_e_exclui_pub_user_pesquisador_Activity : DialogFragment(), OnMapReadyCallback, AdapterView.OnItemSelectedListener  {
    ...
    override fun onResume() {
       ...
       // context?.registerReceiver(broadcastReceive(), IntentFilter(Configuracao_google_maps_Activity.loc_receiver))
        ...
        editMapop.setOnClickListener(){
            getlocation()
            val intent = Intent(context, Configuracao_google_maps_Activity::class.java)
        ...
        val actt = activity as Tela_listagem_publicacao_cadastradas_user_pesquisador_Activity
        val fragment = this@Tela_altera_e_exclui_pub_user_pesquisador_Activity
    ...
    fun onClickupdate(){
        ...
        if(pubpesq?.img1 != "" && pubpesq?.img2 != "" && pubpesq?.img3 != "" && pubpesq?.img4 != "" && pubpesq?.nome != "" && pubpesq?.categoria != "") {
            if (Validacpf().validateEmailFormat(email) || email == "") {
                ...
                val handle = Handler()
                Thread {
                    val mainact = activity as Tela_listagem_publicacao_cadastradas_user_pesquisador_Activity
