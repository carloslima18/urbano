...
class Tela_listagem_pub_user_peesquisador_Adapter(val listpubpesq: List<Pubpesq>, val onClick: (Pubpesq) -> Unit, val onLongClickListener: (Pubpesq) -> Boolean) : RecyclerView.Adapter<Tela_listagem_pub_user_peesquisador_Adapter.ViewHolder>() {
