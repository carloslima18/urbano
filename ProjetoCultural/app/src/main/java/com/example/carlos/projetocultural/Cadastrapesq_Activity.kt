...
import kotlinx.android.synthetic.main.content_cadastrapesq_.*
import org.jetbrains.anko.alert
import org.json.JSONObject
import com.example.carlos.projetocultural.utils.Validacpf


class Cadastrapesq_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cadastrapesq_)
    ...
    fun onClickaceitacontrato_para_ser_pesquisador() {
        if (AndroidUtils.isNetworkAvailable(applicationContext)) {
            ...
            val fragAnterior = supportFragmentManager.findFragmentByTag(InfocadastropesqDialogFragment.KEY)
            ...
            val dialog = InfocadastropesqDialogFragment()//estancia o fragment para passar os dados do bundle
            dialog.arguments = bundle
            dialog.show(ft, InfocadastropesqDialogFragment.KEY)//chama o fragment
        }else{
            toast("Sem Conexão")
        }
    }
