...
class PubuserAdapter(val carros: List<Pubuser>, val onClick: (Pubuser) -> Unit,val onLongClickListener: (Pubuser) -> Boolean) : RecyclerView.Adapter<PubuserAdapter.ViewHolder>() {
